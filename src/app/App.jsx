	...
	return (
		<div className={s.App}>
			<PageHeader
				...
				ghost={false}
				title="Todolist from AWS"
				extra={[
					isAuth && (
						<div style={{ display: "flex" }}>
							<h3 style={{ color: "#FFF", margin: 0, marginRight: 50, fontSize: 20 }}>{email}</h3>

							<Popconfirm title={`${email}, are you sure you want to sign out??`} onConfirm={logOut} okText="Yes" cancelText="No">
								<Button type="primary" danger style={{ color: "#f9f9f9" }}>
									Sign out
								</Button>
							</Popconfirm>
						</div>
